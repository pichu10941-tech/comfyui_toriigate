...
1. On first use, the node automatically downloads the GGUF model and mmproj from [DraconicDragon/ToriiGate-0.5-GGUF](https://huggingface.co/DraconicDragon/ToriiGate-0.5-GGUF) to HuggingFace's cache directory.
